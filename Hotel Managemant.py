# code written by Praduman K. Prajapati
...
spath = "G:\hotel-management-system-master\images\\1reception.jpg"
simg = ImageTk.PhotoImage(Image.open(spath))
my = Label(sroot, image=simg)
my.image = simg
my.place(x=0, y=0)
Frame(sroot, height=580, width=5, bg='black').place(x=550, y=0)
# chilanka
Label(sroot, text="Online Restaurant Meal Reservation System", font='Timesnewroman 20 ', bg='white', fg='black').place(x=555, y=10)
Label(sroot, text="Made by -", font='Timesnewroman 38 ', bg='white', fg='black').place(x=555, y=90)
Label(sroot, text="Praduman Kumar Prajapati", font='Timesnewroman 30 ', bg='white', fg='grey').place(x=555, y=180)
# Label(sroot, text="ArijitTah@gmail.com", font='Timesnewroman 40', bg='white', fg='grey').place(x=555, y=270)
...
def mainroot():
    ...
    tf_label = Label(top_frame, text='Online Restaurant Meal Reservation System', font='msserif 33', fg='black', bg='gray89', height=70)
    ...
    def hotel_status():
        ...
        # -----------------------------------------------------------------
        nl = Label(b_frame, text='Made by Praduman K. Prajapati', fg='black', bg='gray91', font='msserif 8')
        nl.place(x=925, y=310)
        nl.tkraise()
    ...
    def staff():
        ...
        Label(emp1inf, text="Mr. Satyam Dubey", bg='white', fg="Grey", font='msserif 10').place(x=60, y=37)
        ...
        Label(emp1inf, text="Customer Executive", bg='white', font='msserif 17 bold').place(x=45,
                                                                                            y=0)  # pack(side='top')
        Label(emp1inf, text="Ms.Anupam Singh", bg='white', fg="Grey", font='msserif 10').place(x=45, y=37)
        ...
        Label(emp1inf, text="Mr. Praduman K. Prajapati (Head)", bg='white', fg="Grey", font='msserif 10').place(x=72, y=37)
